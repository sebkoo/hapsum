...
engine; degradation is graceful and visible in the UI. The full design is deferred to ADR-0003
(commit 15) — this ADR only fixes the boundary: all AI behind one interface, on-device first.
